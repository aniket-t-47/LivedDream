            ...
            <div class="card" style="width:50%"> <!-- Adjust width using Bootstrap class -->
                <div class="mb-5">
                    ...
                    <div style="display:flex;flex-direction:column;">
                        ...
                        <div class="area">
                            <button id="area">Living room</button>
                            <button id="area">Bed room</button>
                        </div>
                        <div class="area">
                            <button id="area">Kitchen</button>
                            <button id="area">Bathroom</button>
                        </div>
                        <div class="area">
                            <button id="area">Balcony</button>
                            <button id="area">other</button>
                        </div>
