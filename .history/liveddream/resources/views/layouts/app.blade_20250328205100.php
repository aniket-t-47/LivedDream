...
<li class="nav-item dropdown no-arrow">
    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
        ...
        <span class="mr-2 d-none d-lg-inline text-gray-600 small">Rahul K.</span>
        <img class="img-profile rounded-circle" src="img/user_profile.jpg" alt="User Profile" width="40" height="40">
    </a>
    <!-- Dropdown - User Information -->
