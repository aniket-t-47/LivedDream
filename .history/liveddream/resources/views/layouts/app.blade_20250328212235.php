...
<!-- Topbar Navbar -->
<ul class="navbar-nav ml-auto">  <!-- Added ms-auto to align right -->
    ...
    <li class="nav-item dropdown  no-arrow">
        ...
        <!-- Dropdown Menu -->
        <ul class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">  <!-- Added dropdown-menu-end -->
