...
<head>
    ...
    <style>
        ...
        #sidebartoggle {
            ...
            position: ;
            left: 270px; /* Position it next to the sidebar */
            top: 15px;
            cursor: pointer;
        }

        #sidebar.collapsed + .main-content #sidebartoggle {
            left: 90px; /* Adjust button position when sidebar is collapsed */
        }
        .sidebar.collapsed ~ .main-content {
            margin-left: 80px;
        }
...
<div id="content-wrapper" class="d-flex flex-column" >
   ...
   <!-- Main Content -->
    ...
    //         if (toggleButton && sidebar) {  // Check if elements exist before adding event listener
    //             toggleButton.addEventListener('click', function () {
    //                 sidebar.classList.toggle('collapsed');
    //             });
    //         } else {
    //             console.error("Sidebar toggle button or sidebar not found in DOM.");
    //         }
    //     });
    ...
    document.addEventListener("DOMContentLoaded", function () {
            ...
            if (toggleButton && sidebar && mainContent) {  
                ...
                console.error("Sidebar toggle button or main content not found in DOM.");
            }
        });
