...
<ul class="navbar-nav me-auto">  <!-- Added ms-auto to align right -->
    ...
    <li class="nav-item dropdown-menu-end" style="background-color:red">
        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
            <span class="mr-2 d-none d-lg-inline text-gray-600 small">Douglas McGee</span>
            <img class="img-profile rounded-circle" src="img/undraw_profile.svg" style="background-color:red">
        </a>
