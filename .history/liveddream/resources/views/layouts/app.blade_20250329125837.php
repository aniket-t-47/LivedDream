   ...
   <!-- Main Content -->
    ...
    <!-- Sidebar  -->
     <div class="sidebar">
        ...
        <a href="#" class="nav-item"> <img src="img/hugeicons_menu-square.png" alt=""> <spanclass="nav-text">Dashboard</span></a>
        ...
        <a href="/adhesive" class="nav-item"><img src="img/Vector (5).png" alt=""><span class="nav-item">Adhesive</span> </a>
        <a href="#" class="nav-item"><img src="img/Vector (6).png" alt=""><span class="nav-item">Samples</span> </a>
        <a href="#" class="nav-item"> <img src="img/solar_users-group-rounded-outline.png" alt=""><span class="nav-item"> Users</span></a>
    </div>
