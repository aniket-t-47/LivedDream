...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/quotatio.css') }}">
    
    <!-- <link rel="stylesheet" href="D:\Extraaazpos\LivedDream\liveddream\public\css\product.css"> -->
...
<body>
    ...
    <div class="container">
        @yield('content')  <!-- This will load content from child templates -->
    </div>
