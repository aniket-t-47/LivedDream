                    ...
                    <div class="card">
                        ...
                        <div class="card m-2">
                            <div class="m-3">
                                ...
                                <div class="modal fade" id="addproduct" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="background-color:green">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body" style="width:800px;">
                                                <form>
                                                    <div style="display:flex;flex-direction:row;gap:5%;width:800">
                                                        <div class="column" >
                                                            <div class="mb-3">
