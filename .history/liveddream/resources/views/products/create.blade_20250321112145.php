                                                ...
                                                <form>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="number" class="form-control" id="purchaseCost" placeholder="₹ 00" requiredrequired>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label for="sellingPrice" class="form-label">Selling price*</label>
                                                            <input type="number" class="form-control" id="sellingPrice" placeholder="₹ 00">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3">
